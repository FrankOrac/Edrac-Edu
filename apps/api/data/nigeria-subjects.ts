...
export const nigeriaSubjects: Subject[] = [
  // Core Subjects
  {
    id: 'english',
...
export const getSubjectsByLevel = (level: string) => {
  return nigeriaSubjects.filter(subject => subject.level === level);
};

export const getSubjectsByCategory = (category: string) => {
  return nigeriaSubjects.filter(subject => subject.category === category);
};

export const getSubjectsByExamType = (examType: string) => {
  return nigeriaSubjects.filter(subject => subject.examType === examType || subject.examType === 'All');
};
