...
const getAIResponse = (message, context = 'general') => {
...
// AI Chat endpoint
router.post('/chat', index_1.auth, async (req, res) => {
    try {
...
router.get('/study-recommendations', index_1.auth, async (req, res) => {
    try {
        const user = req.user;
...
router.post('/generate-questions', index_1.auth, async (req, res) => {
    try {
        ...
        const generateTopicQuestions = (subject, topic, difficulty, count) => {
            const baseQuestions = {
                mathematics: {
                    algebra: [
        ...
        const generateOptions = (question, subject, topic) => {
        ...
        if (topic) {
            ...
            const templates = questionTemplates[subject.toLowerCase()] || questionTemplates.mathematics;
...
router.post('/bulk-generate-questions', index_1.auth, async (req, res) => {
    try {
...
// AI Comment Response
router.post('/comment-response', index_1.auth, async (req, res) => {
...
router.post('/generate-materials', index_1.auth, async (req, res) => {
    try {
